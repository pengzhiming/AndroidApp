...
public class BaseMvpProxy<V extends BaseMvpView, P extends BaseMvpPresenter<V>> implements PresenterProxyInterface<V, P>{
    ...
    public P getMvpPresenter() {
        DLog.v("perfect-mvp","Proxy getMvpPresenter");
        if (mFactory != null) {
            if (mPresenter == null) {
        ...
        DLog.v("perfect-mvp","Proxy getMvpPresenter = " + mPresenter);
        return mPresenter;
    }
    ...
    public void onResume(V mvpView) {
        getMvpPresenter();
        DLog.v("perfect-mvp","Proxy onResume");
    ...
    private void onDetachMvpView() {
        DLog.v("perfect-mvp","Proxy onDetachMvpView = ");
        if (mPresenter != null && mIsAttchView) {
    ...
    public void onDestroy() {
        DLog.v("perfect-mvp","Proxy onDestroy = ");
        if (mPresenter != null ) {
            onDetachMvpView();
    ...
    public Bundle onSaveInstanceState() {
        DLog.v("perfect-mvp","Proxy onSaveInstanceState = ");
    ...
    public void onRestoreInstanceState(Bundle savedInstanceState) {
        DLog.v("perfect-mvp","Proxy onRestoreInstanceState = ");
        DLog.v("perfect-mvp","Proxy onRestoreInstanceState Presenter = " + mPresenter);
