...
import com.core.R;
import com.core.LZCore;
import com.core.component.log.DLog;
import com.core.component.net.exception.ApiException;
import com.core.component.net.exception.ExceptionEngine;
import com.core.component.net.view.DialogHelper;
import com.core.component.net.view.IBaseView;
...
public abstract class RxSubscriberHelper<T> extends Subscriber<T> {
  ...
  protected void onShowMessage(ApiException apiException) {
    if (apiException != null && !TextUtils.isEmpty(apiException.message)) {
      Toast.makeText(LZCore.sContext, apiException.message, Toast.LENGTH_SHORT).show();
    } else {
      Toast.makeText(LZCore.sContext, LZCore.sContext.getApplicationContext().getString(R.string.common_net_error_default), Toast.LENGTH_SHORT).show();
    }
  }
}
